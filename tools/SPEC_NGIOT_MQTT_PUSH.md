...
> **SUPERSEDED (2026-06-30).** An instrumented trace of the official app (closed fork PR)
...
> `SPEC_ADAPTIVE_POLLING.md` (open fork PR). This spec is kept only for history and in
